...
const cacheName = 'LAWk7JosieMoran-2021-03-22 20:47:24.707093'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWk7JosieMoran'.length) === 'LAWk7JosieMoran') {
